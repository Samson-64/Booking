    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-900 px-4 py-12 selection:bg-teal-500 selection:text-white relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-tr from-teal-500 to-emerald-400 text-white shadow-xl shadow-teal-500/20 mb-4">
